...
final class Classes {
	 ...
	 */
	private static final String BLD_PKG = "com.lyra.meta.builder.impl";
	/**
	 ...
	 */
	private static final String DAO_PKG = "com.lyra.db.sql.impl";
	/**
	 ...
	 * Default Dao component classes' package full name. *
	 */
	private static final String DAO_OAUTH_PKG = "com.lyra.db.sql.sec.impl";
	/**
	 ...
	 */
	public static final String CTX_CONTEXT = "com.lyra.meta.impl.GenericContext";
