...
/**
 * Default implementation of {@link com.lyra.vertx.jersey.WriteStreamOutput}
 */
public class DefaultWriteStreamOutput implements WriteStreamOutput {
	 ...
	 */
	@Override
	public WriteStreamOutput init(HttpServerResponse response,
	 ...
	 * {@link org.vertx.java.core.http.HttpServerResponse} has been set yet.
	 *
	 * @return boolean flag
	 */
	@Override
	...
	private void checkResponseSet() {
		if (response == null)
			throw new IllegalStateException(
					"The HttpServerResponse has not been set yet.");
	}
